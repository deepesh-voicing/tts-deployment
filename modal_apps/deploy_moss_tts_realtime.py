"""Serve MOSS-TTS-Realtime through vLLM-Omni on Modal as 8 kHz PCM."""
...
APP_NAME = "tts-l40s-moss-tts-realtime"
...
VLLM_PORT = 8000
MAX_INPUTS = 64
STAGE_OVERRIDES = '{"0":{"max_num_seqs":64},"1":{"max_num_seqs":8}}'
MAX_CONTAINERS = 1
...
CACHE_PATH = "/cache"
DEPLOY_CONFIG_PATH = "/opt/tts/moss_tts_realtime_compat.yaml"
...
image = (
    ...
    .entrypoint([])
    .add_local_file(
        "modal_apps/configs/moss_tts_realtime_compat.yaml",
...
def _build_api():
    ...
    api = FastAPI(title="MOSS-TTS-Realtime 8 kHz", lifespan=lifespan)
